    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl dark:shadow-gray-900/50 p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">계정 정보</h3>
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-300">이름</label>
                    <p className="text-gray-800 dark:text-gray-200">{session.user?.name || "설정되지 않음"}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-300">이메일</label>
                    <p className="text-gray-800 dark:text-gray-200">{session.user?.email}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-300">가입일</label>
                    <p className="text-gray-800 dark:text-gray-200">2024년 12월</p>
                  </div>
                </div>
              </div>

              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">활동 통계</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">완료한 테스트</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800 dark:text-gray-200">오늘</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">회원 등급</span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl dark:shadow-gray-900/50 p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">MBTI 테스트 기록</h2>
              <Link
                href="/test"
            ...
            {mbtiHistory.length === 0 ? (
              ...
              <div className="space-y-4">
                {mbtiHistory.map((record, index) => (
                  <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md dark:hover:shadow-gray-900/50 transition-shadow">
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="flex items-center mb-2">
                          ...
                          <span className="text-gray-700 dark:text-gray-200">{getMBTIDescription(record.result)}</span>
                        </div>
          ...
          <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-xl dark:shadow-gray-900/50 p-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">추천 기능</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                <div className="text-3xl mb-4">💝</div>
                <h3 className="font-semibold mb-2 dark:text-gray-100">궁합 분석</h3>
              ...
              <div className="text-center p-6 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
                <div className="text-3xl mb-4">👥</div>
                <h3 className="font-semibold mb-2 dark:text-gray-100">커뮤니티</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                  같은 타입의 사람들과 소통해보세요
                </p>
              ...
              <div className="text-center p-6 bg-pink-50 dark:bg-pink-900/30 rounded-lg">
                <div className="text-3xl mb-4">📊</div>
                <h3 className="font-semibold mb-2 dark:text-gray-100">상세 분석</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                  내 성격의 세부적인 분석을 받아보세요
                </p>
                <button className="text-pink-600 hover:text-pink-800 dark:text-pink-400 dark:hover:text-pink-300 font-medium">
                  분석받기
                </button>
              </div>
            </div>
